...
#define NU32_DESIRED_BAUD 250000    // Baudrate for RS232
...
void NU32_Startup() {
  ...
  TRISECLR = 0x000f;  // Make E0 to E3 outputs (LED1 to LED4)
  YELLOW_LED = 1;      // LED1 is off
  RED_LED = 1;      // LED2 is off
  WHITE_LED = 0;      //LED3 is off
  GREEN_LED = 0;        //LED4 is on
